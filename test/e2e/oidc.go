...
const (
	defaultLocalPort  = 18443
	defaultIssuerPort = 8443
	...
	return func(t *testing.T) {
		...
		kubetest.Scenario{
			...
			Given: kubetest.Actions(
				...
				kubetest.CreateClientCerts(client, "kube-rbac-proxy-oidc-client"),
			...
			Then: kubetest.Actions(
				...
				kubetest.VerifyGetExactly(mockServerURL, kubetest.DefaultConfigURL, 1),
				// TODO: enabled when fixed
				//kubetest.VerifyGetExactly(mockServerURL, DefaultCertsURL, 0),
			),
		}.Run(t)
		...
		kubetest.Scenario{
			...
			Then: kubetest.Actions(
				...
				kubetest.VerifyGetExactly(mockServerURL, kubetest.DefaultConfigURL, 1),
				kubetest.VerifyGetExactly(mockServerURL, kubetest.DefaultCertsURL, 3),
			),
		}.Run(t)
		...
		kubetest.Scenario{
			...
			Then: kubetest.Actions(
				...
				kubetest.VerifyGetExactly(mockServerURL, kubetest.DefaultConfigURL, 1),
				kubetest.VerifyGetExactly(mockServerURL, kubetest.DefaultCertsURL, 1),
			),
		}.Run(t)
